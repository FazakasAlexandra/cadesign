...
export default function NavSteps({ steps, setSteps }) {
    ...
    return <div className="navsteps-wraper">
        ...
        <div className="navsteps pagination">
            <div className="pagination-button prev" onClick={() => handleSelectStep(currentStep - 1)}><FontAwesomeIcon icon={faAngleLeft} /><span>Pasul Anterior</span></div>
            <div className="pagination-button next" onClick={() => handleSelectStep(currentStep + 1)}><span>Pasul Urmator</span><FontAwesomeIcon icon={faAngleRight} /></div>
        </div>
    </div>
}